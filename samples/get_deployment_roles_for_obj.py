...
def main():
    ...
    with bluecat_bam.BAM(args.server, args.username, args.password) as conn:
        ...
        for obj in obj_list:
            get_deployment_roles(obj, conn)


def get_deployment_roles(obj, conn):
    ...
    for role in roles:
        ...
        out = "    {} {} {}".format(role["service"], role["type"], role_server["name"])
        # print(out)
        outlist.append(out)
        ...
        if sec:
            ...
            out = "    {} {} {}".format(role["service"], "SLAVE", role_server["name"])
            # print(out)
            outlist.append(out)
